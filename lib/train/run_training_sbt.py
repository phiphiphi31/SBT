...
def run_training(script_name, config_name, cudnn_benchmark=True, local_rank=-1, save_dir=None, base_seed=None,
    ...
    if distill:
        ...
        expr_module = importlib.import_module('lib.train.train_script_sbt')
...
def main():
    ...
    parser.add_argument('--script', type=str, default='sbt', help='Name of the train script.')
    parser.add_argument('--config', type=str, default='sbt_base_debug', help="Name of the config file.")
