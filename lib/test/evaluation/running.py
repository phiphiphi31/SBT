...
def _save_tracker_output(seq: Sequence, tracker: Tracker, output: dict):
    ...
    dataset_folder_path = os.path.join(tracker.results_dir, seq.dataset)
    if not os.path.exists(dataset_folder_path):
        print("create dataset result dir:", dataset_folder_path)
        os.makedirs(dataset_folder_path)

    video_folder_path = os.path.join(tracker.results_dir, seq.dataset, seq.name)
    ...
    def _results_exist():
        if seq.object_ids is None:
            if seq.dataset in ['got10k']:
                ...
                bbox_file = '{}/{}/{}/{}.txt'.format(tracker.results_dir, seq.dataset,seq.name, seq.name)
