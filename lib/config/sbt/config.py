...
cfg.MODEL.ADJUST_DIM=None
cfg.MODEL.HEAD_MIXER_HW = None
...
cfg.MODEL.BACKBONE.WEIGHT = None
cfg.MODEL.BACKBONE.EXTRACT_MODE = 'sep'
cfg.MODEL.BACKBONE.STRIDE = 8
# MODEL.TRANSFORMER
...
cfg.TRAIN.CE_WEIGHT = 120.0
cfg.TRAIN.BBOX_WEIGHT = 70.0
cfg.TRAIN.GIOU_WEIGHT = 50.0
