...
"""sbt"""
#trackers.extend(trackerlist(name='sbt', parameter_name='sbt_base', dataset_name=dataset_name,
       #                     run_ids=None, display_name='SBT-BASE'))
trackers.extend(trackerlist(name='sbt', parameter_name='sbt_base', dataset_name=dataset_name,
                            run_ids=None, display_name='SBT-BASE-ep500'))

trackers.extend(trackerlist(name='ostrack', parameter_name='vit_large_fulldata_000', dataset_name=dataset_name,
                            run_ids=None, display_name='vit_large_fulldata_100'))
